...
class SimpleSlides extends HTMLElement {
  ...
  // FIXME: Finding the min size is probably a bad solution. 
  // Better to have developers supply the image sizes. 
  // TODO: Fix this to work with any content, not just images. 
  // Maybe slots could be used here? Imagine a slot generated 
  // for each "slide" element?

  // Helper method - This method finds the min width and height 
  // between all images. 
  _setSize() {
    // Let's reduce the array of imgs to a size object with a width and height. 
  ...
  _showImg() {
    ...
    // FIXME: There is a flash between some slides. Not sure could be
    // - due to opcaity changes
    // - zIndex issue
    // - or? 
    this._imgA.src = img.src
    this._imgA.style.zIndex = 1
    this._imgB.style.zIndex = 2
